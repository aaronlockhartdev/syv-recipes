...
#   w4a16-int4-mtp      recipes/w4a16-int4-mtp.sh      -- int4 KV, Qwen MTP head, 3 drafts
#   w4a16-k4v2-dflash2  recipes/w4a16-k4v2-dflash2.sh  -- KVarN 4/2-bit KV, the full 262k context
#   w4a16-k4v2-mtp      recipes/w4a16-k4v2-mtp.sh      -- KVarN 4/2-bit KV, Qwen MTP head, 3 drafts
...
case "$cmd" in
  w4a16-int8-dflash2|w4a16-int8-mtp|w4a16-bf16-dflash2|w4a16-int4-dflash2|w4a16-int4-mtp|w4a16-k4v2-dflash2|w4a16-k4v2-mtp|w4a8-int8-dflash2|w4a16-int8-dspark)
